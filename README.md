...
> 当前处于开发阶段，可下载预构建版本或从源码构建。

### 方式一：下载预构建版本

前往 [Releases](https://github.com/despa1r1022/skill-forge/releases) 页面，选择对应平台下载：

| 操作系统 | 安装包 |
|----------|--------|
| **macOS** | `SkillForge_*.dmg` |
| **Windows** | `SkillForge_*.msi` 或 `.exe` |
| **Linux (Debian/Ubuntu)** | `SkillForge_*.deb` |
| **Linux (Fedora/RHEL)** | `SkillForge_*.rpm` |
| **Linux (通用)** | `SkillForge_*.AppImage` |
